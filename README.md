...
## Demo Script
Refer to [DEMO_SCRIPT.txt](DEMO_SCRIPT.txt) for a complete spoken narration guide.
...
2. In your terminal, navigate into your project folder:
   ...
   git init
   git add .
   git commit -m "Initial commit: ayush-mitra ADK agent"
   git branch -M main
   git remote add origin https://github.com/Resilient-01/ayush-mitra.git
